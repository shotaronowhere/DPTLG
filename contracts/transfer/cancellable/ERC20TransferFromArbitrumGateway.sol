...
contract ERC20TransferFromArbitrumGateway is IERC20TransferGateway{
    ...
    uint256 public constant cancellation_buffer = 691200; // 8 days for bridge unhappy path of bridge to (add fastbridge epochs to be safe, not included)
